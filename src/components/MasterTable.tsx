const rows = [
  ...
  },
  {
    ...
    isolation: "Ubuntu 24.04 VMs",
    persistence: "25 GB persistent",
    gpu: "No",
    coldStart: "Sub-second",
    openSource: "No",
    selfHosted: "No",
    pricing: "$20/mo (25 machines)",
  },
  {
  ...
  },
  {
    category: "Managed",
    name: "Zo Computer",
    isolation: "Always-on cloud server",
    persistence: "100 GB + cloud storage",
    gpu: "\u2014",
    coldStart: "\u2014",
    openSource: "No",
    selfHosted: "No",
